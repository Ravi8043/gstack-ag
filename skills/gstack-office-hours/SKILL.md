...
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
B=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/gstack-ag-dist/skills/browse/dist/browse" ] && B="$_ROOT/gstack-ag-dist/skills/browse/dist/browse"
...
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
D=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/gstack-ag-dist/skills/design/dist/design" ] && D="$_ROOT/gstack-ag-dist/skills/design/dist/design"
...
```bash
~/.gemini/config/plugins/gstack-ag/bin/gstack-developer-profile --log-session '{"date":"TIMESTAMP","mode":"MODE","project_slug":"SLUG","signal_count":N,"signals":SIGNALS_ARRAY,"design_doc":"DOC_PATH","assignment":"ASSIGNMENT_TEXT","resources_shown":[],"topics":TOPICS_ARRAY}' 2>/dev/null || true
```
...
```bash
PROFILE=$(~/.gemini/config/plugins/gstack-ag/bin/gstack-builder-profile 2>/dev/null) || PROFILE="SESSION_COUNT: 0
TIER: introduction"
...
```bash
eval "$(~/.gemini/config/plugins/gstack-ag/bin/gstack-paths)"
...
```bash
eval "$(~/.gemini/config/plugins/gstack-ag/bin/gstack-slug 2>/dev/null || true)"
~/.gemini/config/plugins/gstack-ag/bin/gstack-developer-profile --log-session '{"date":"'"$(date -u +%Y-%m-%dT%H:%M:%SZ)"'","mode":"resources","project_slug":"'"${SLUG:-unknown}"'","signal_count":0,"signals":[],"design_doc":"","assignment":"","resources_shown":["URL1","URL2","URL3"],"topics":[]}' 2>/dev/null || true
```
