...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/gstack-ag-dist/skills/extension/manifest.json" ] && _EXT_PATH="$_ROOT/gstack-ag-dist/skills/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/gstack-ag-dist/skills/extension/manifest.json" ] && _EXT_PATH="$HOME/gstack-ag-dist/skills/extension"
