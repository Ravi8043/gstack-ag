...
```bash
DISCOVER_BIN=""
[ -x ~/.gemini/config/plugins/gstack-ag/bin/gstack-global-discover ] && DISCOVER_BIN=~/.gemini/config/plugins/gstack-ag/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x gstack-ag-dist/skills/bin/gstack-global-discover ] && DISCOVER_BIN=gstack-ag-dist/skills/bin/gstack-global-discover
