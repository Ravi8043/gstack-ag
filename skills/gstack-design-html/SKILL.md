...
_PRETEXT_VENDOR=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/gstack-ag-dist/skills/design-html/vendor/pretext.js" ] && _PRETEXT_VENDOR="$_ROOT/gstack-ag-dist/skills/design-html/vendor/pretext.js"
[ -z "$_PRETEXT_VENDOR" ] && [ -f ~/.gemini/config/plugins/gstack-ag/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=~/.gemini/config/plugins/gstack-ag/design-html/vendor/pretext.js
